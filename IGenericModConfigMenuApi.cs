// Copied from a mod that predates nullable reference types, so its signatures use bare null
// defaults. Disable the annotations here rather than rewriting the third-party contract.
#nullable disable
...
/// <summary>
/// Generic Mod Config Menu's API, copied verbatim from the installed GMCM 1.16.0 so this mod can
/// compile without referencing its assembly. SMAPI resolves this interface against GMCM at
/// runtime, matching each member by name and signature.
/// </summary>
/// <remarks>
/// Only needed for in-game config editing; <c>config.json</c> keeps working when GMCM is absent.
/// </remarks>
